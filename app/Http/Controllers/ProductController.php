...
class ProductController extends Controller
{
    ...
    public function all_product(){
        $this->AuthLogin();
    	$all_product = DB::table('tbl_product')->join('tbl_category_product','tbl_category_product.category_id', 'tbl_product.category_id')->join('tbl_brand','tbl_brand.brand_id', 'tbl_product.brand_id')->orderBy('tbl_product.product_id')->get();
    ...
    public function save_product(Request $request){
        ...
        if($get_image){
            $get_name_imgage = $get_image->getClientOriginalName();
            $name_image = current(explode('.', $get_name_imgage));
    ...
    public function show_details($product_id){
        ...
        return view('page.product.show_details')->with('cate', $cate_product)->with('brand', $brand_product)->with('details_product', $details_product)->with('related_product', $related_product);
    }
}
